...
set CLASSPATH=%CLASSPATH%;%KARAF_HOME%\system\org\apache\sshd\sshd-core\0.12.0.redhat-002\sshd-core-0.12.0.redhat-002.jar
set CLASSPATH=%CLASSPATH%;%KARAF_HOME%\system\org\apache\mina\mina-core\2.0.9\mina-core-2.0.9.jar
set CLASSPATH=%CLASSPATH%;%KARAF_HOME%\system\org\apache\karaf\shell\org.apache.karaf.shell.console\2.4.0.redhat-620133\org.apache.karaf.shell.console-2.4.0.redhat-620133.jar
