...
Fuse
-----
1. Create a ${FUSE_HOME}/quickstarts/demos/policy-security-basic/ directory, and copy connector.jks into it.

2. Create a ${FUSE_HOME}/etc/org.ops4j.pax.web.cfg file, with the following contents:
...
5. Add the features URL for the respective version of SwitchYard.  

JBossFuse:karaf@root> features:addurl mvn:org.switchyard.karaf/switchyard/${switchyard.version}/xml/core-features

6. Install the feature for the bean-service quickstart :
...
JBossFuse:karaf@root> features:uninstall switchyard-quickstart-bean-service
